...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="{{ route('receptionist.add.patient') }}">
                <button class="btn btn-success add-btn">Add Patient</button>
            </a>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($patients as $patient)
                    <tr>
                        <th>{{ $patient->firstName . ' ' . $patient->fatherName . ' ' . $patient->lastName }}</th>
                        ...
                        <td>
                            ...
                            <form
                                action="{{ route('receptionist.transfer-patient', ['patient_id' => Crypt::encrypt($patient->id)]) }}"
                                method="POST">
                                @csrf
                                <!-- Modal -->
                        ...
                        <td>
                            <a
                                href="{{ route('receptionist.edit.patient', ['patient_id' => Crypt::encrypt($patient->id)]) }}">
    ...
    @if ($getAll === true)
        <div class="footer">
            <a href="{{ route('receptionist.patient.search') }}">
